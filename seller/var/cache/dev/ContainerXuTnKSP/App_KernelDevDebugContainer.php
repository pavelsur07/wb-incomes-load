...
class App_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            ...
            'App\\Controller\\Api\\V1\\HomeController' => 'getHomeControllerService',
            'App\\Controller\\HomeController' => 'getHomeController2Service',
            'App\\Controller\\Stat\\StatsController' => 'getStatsControllerService',
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $b->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver(($this->privates['annotations.cached_reader'] ?? $this->getAnnotations_CachedReaderService()), [0 => (\dirname(__DIR__, 4).'/src/Model/Stat/Entity')]), 'App\\Model\\Stat\\Entity');

        $a->setEntityNamespaces(['Stat' => 'App\\Model\\Stat\\Entity']);
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'doctrine.dbal.connection_factory.types' => [
                'wb_stat_supplier_id' => [
                    'class' => 'App\\Model\\Stat\\Entity\\Supplier\\IdType',
                ],
                'wb_stat_incomes_transaction_key' => [
                    'class' => 'App\\Model\\Stat\\Entity\\Incomes\\TransactionKeyType',
                ],
            ],
