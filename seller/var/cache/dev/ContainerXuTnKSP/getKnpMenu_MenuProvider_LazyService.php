...
class getKnpMenu_MenuProvider_LazyService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['knp_menu.menu_provider.lazy'] = new \Knp\Menu\Provider\LazyProvider(['sidebar' => [0 => function () use ($container) {
            return ($container->privates['App\\Menu\\SidebarMenu'] ?? $container->load('getSidebarMenuService'));
        }, 1 => 'build']]);
    }
}
